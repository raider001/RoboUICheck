...
public class MouseControllerTests {
    ...
    @Test
    public void mouseScroll_validation() {
        sut.mouseScroll(2);
        Mockito.verify(r,Mockito.times(1)).mouseWheel(2);
    }

    @Test
    public void setMouseMoveSpeed_validation() {
        sut.setMouseMoveSpeed(10);
        Assertions.assertEquals(10, sut.getMouseMoveSpeed());
    }

    @Test
    public void moveMouse_movesRelativeToOriginal() {
    ...
    @Test
    public void moveMouse_moveMouseToDisplay() throws Exception {
    ...
    @Test
    public void moveMouse_moveMouseCurrentDisplay() throws Exception {
        Mockito.when(mic.getMousePosition()).thenReturn(new Point(100,100));
