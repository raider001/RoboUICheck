...
class MatchTemplateDemoRun implements ChangeListener {
    ...
    JLabel imgDisplay = new JLabel(), resultDisplay = new JLabel(), maskDisplay = new JLabel();
    //! [declare]
    ...
    public void run(String[] args) {
        ...
        mask = Imgcodecs.imread(args[1], Imgcodecs.IMREAD_UNCHANGED);
        Imgproc.threshold(mask,mask,0,255,Imgproc.THRESH_BINARY);

//        Image tmpImg = HighGui.toBufferedImage(mask);
//        ImageIcon icon = new ImageIcon(tmpImg);
//        maskDisplay.setIcon(icon);
