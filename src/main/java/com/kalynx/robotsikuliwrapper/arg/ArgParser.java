package com.kalynx.robotsikuliwrapper.arg;
...
public class ArgParser {
    ...
    public void parse(String... args) {
        ...
        argList.stream().filter(arg -> appliedArgs.contains(arg.key) && arg.defaultVal != null).forEach(arg -> ((Consumer<Object>)arg.cmd).accept(arg.defaultVal));
    }
